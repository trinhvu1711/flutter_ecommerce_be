package com.springbootjwt.security.config;
...
import static com.springbootjwt.security.user.Permission.*;
        ...
        http
                ...
                .authorizeHttpRequests(
                        req -> req.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers(PUT,"/api/v1/users/forgot-password/**").permitAll()
                                .requestMatchers(PUT,"/api/v1/users/set-password/**").permitAll()
